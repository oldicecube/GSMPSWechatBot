...
export class WcdbCore {
  ...
  async initialize(): Promise<boolean> {
    ...
    try {
      ...
      // 定义类型
      const sf = (sig) => {
        try { return this.lib.func(sig) }
        catch (e) { /* 预期内的缺失，静默跳过 */ return null }
      }

      // wcdb_status wcdb_init()
      this.wcdbInit = sf('int32 wcdb_init()')

      // wcdb_status wcdb_shutdown()
      this.wcdbShutdown = sf('int32 wcdb_shutdown()')

      // wcdb_status wcdb_open_account(const char* session_db_path, const char* hex_key, wcdb_handle* out_handle)
      // wcdb_handle 是 int64_t
      this.wcdbOpenAccount = sf('int32 wcdb_open_account(const char* path, const char* key, _Out_ int64* handle)')

      // wcdb_status wcdb_close_account(wcdb_handle handle)
      //  C 接口是 int64， koffi 返回 handle 是 number 类型
      this.wcdbCloseAccount = sf('int32 wcdb_close_account(int64 handle)')

      // wcdb_status wcdb_set_my_wxid(wcdb_handle handle, const char* wxid)
      try {
        this.wcdbSetMyWxid = sf('int32 wcdb_set_my_wxid(int64 handle, const char* wxid)')
      } catch {
      ...
      try {
        this.wcdbUpdateMessage = sf('int32 wcdb_update_message(int64 handle, const char* sessionId, int64 localId, int32 createTime, const char* newContent, _Out_ void** outError)')
      } catch {
      ...
      try {
        this.wcdbDeleteMessage = sf('int32 wcdb_delete_message(int64 handle, const char* sessionId, int64 localId, int32 createTime, const char* dbPathHint, _Out_ void** outError)')
      } catch {
        this.wcdbDeleteMessage = null
      }

      // void wcdb_free_string(char* ptr)
      this.wcdbFreeString = sf('void wcdb_free_string(void* ptr)')

      // wcdb_status wcdb_get_sessions(wcdb_handle handle, char** out_json)
      this.wcdbGetSessions = sf('int32 wcdb_get_sessions(int64 handle, _Out_ void** outJson)')

      // wcdb_status wcdb_mark_all_sessions_read(wcdb_handle handle, char** out_error)
      try {
        this.wcdbMarkAllSessionsRead = sf('int32 wcdb_mark_all_sessions_read(int64 handle, _Out_ void** outError)')
      } catch {
      ...
      this.wcdbGetMessages = sf('int32 wcdb_get_messages(int64 handle, const char* username, int32 limit, int32 offset, _Out_ void** outJson)')

      // wcdb_status wcdb_get_message_count(wcdb_handle handle, const char* username, int32_t* out_count)
      this.wcdbGetMessageCount = sf('int32 wcdb_get_message_count(int64 handle, const char* username, _Out_ int32* outCount)')

      // wcdb_status wcdb_get_message_by_svrid(wcdb_handle handle, const char* session_id, const char* svrid, char** out_json)
      this.wcdbGetMessageByServerId = sf('int32 wcdb_get_message_by_svrid(int64 handle, const char* sessionId, const char* svrid, _Out_ void** outJson)')

      // wcdb_status wcdb_get_display_names(wcdb_handle handle, const char* usernames_json, char** out_json)
      this.wcdbGetDisplayNames = sf('int32 wcdb_get_display_names(int64 handle, const char* usernamesJson, _Out_ void** outJson)')

      // wcdb_status wcdb_get_avatar_urls(wcdb_handle handle, const char* usernames_json, char** out_json)
      this.wcdbGetAvatarUrls = sf('int32 wcdb_get_avatar_urls(int64 handle, const char* usernamesJson, _Out_ void** outJson)')

      // wcdb_status wcdb_get_group_member_count(wcdb_handle handle, const char* chatroom_id, int32_t* out_count)
      this.wcdbGetGroupMemberCount = sf('int32 wcdb_get_group_member_count(int64 handle, const char* chatroomId, _Out_ int32* outCount)')

      // wcdb_status wcdb_get_group_member_counts(wcdb_handle handle, const char* chatroom_ids_json, char** out_json)
      try {
        this.wcdbGetGroupMemberCounts = sf('int32 wcdb_get_group_member_counts(int64 handle, const char* chatroomIdsJson, _Out_ void** outJson)')
      } catch {
      ...
      this.wcdbGetGroupMembers = sf('int32 wcdb_get_group_members(int64 handle, const char* chatroomId, _Out_ void** outJson)')

      // wcdb_status wcdb_get_group_nicknames(wcdb_handle handle, const char* chatroom_id, char** out_json)
      try {
        this.wcdbGetGroupNicknames = sf('int32 wcdb_get_group_nicknames(int64 handle, const char* chatroomId, _Out_ void** outJson)')
      } catch {
      ...
      this.wcdbGetMessageTables = sf('int32 wcdb_get_message_tables(int64 handle, const char* sessionId, _Out_ void** outJson)')
      ...
      this.wcdbGetMessageMeta = sf('int32 wcdb_get_message_meta(int64 handle, const char* dbPath, const char* tableName, int32 limit, int32 offset, _Out_ void** outJson)')

      // wcdb_status wcdb_get_contact(wcdb_handle handle, const char* username, char** out_json)
      this.wcdbGetContact = sf('int32 wcdb_get_contact(int64 handle, const char* username, _Out_ void** outJson)')

      // wcdb_status wcdb_get_contact_status(wcdb_handle handle, const char* usernames_json, char** out_json)
      try {
        this.wcdbGetContactStatus = sf('int32 wcdb_get_contact_status(int64 handle, const char* usernamesJson, _Out_ void** outJson)')
      } catch {
        this.wcdbGetContactStatus = null
      }

      try {
        this.wcdbGetContactTypeCounts = sf('int32 wcdb_get_contact_type_counts(int64 handle, _Out_ void** outJson)')
      } catch {
        this.wcdbGetContactTypeCounts = null
      }
      try {
        this.wcdbGetContactsCompact = sf('int32 wcdb_get_contacts_compact(int64 handle, const char* usernamesJson, _Out_ void** outJson)')
      } catch {
        this.wcdbGetContactsCompact = null
      }
      try {
        this.wcdbGetContactAliasMap = sf('int32 wcdb_get_contact_alias_map(int64 handle, const char* usernamesJson, _Out_ void** outJson)')
      } catch {
        this.wcdbGetContactAliasMap = null
      }
      try {
        this.wcdbGetContactFriendFlags = sf('int32 wcdb_get_contact_friend_flags(int64 handle, const char* usernamesJson, _Out_ void** outJson)')
      } catch {
        this.wcdbGetContactFriendFlags = null
      }
      try {
        this.wcdbGetChatRoomExtBuffer = sf('int32 wcdb_get_chat_room_ext_buffer(int64 handle, const char* chatroomId, _Out_ void** outJson)')
      } catch {
      ...
      this.wcdbGetMessageTableStats = sf('int32 wcdb_get_message_table_stats(int64 handle, const char* sessionId, _Out_ void** outJson)')
      ...
      this.wcdbGetAggregateStats = sf('int32 wcdb_get_aggregate_stats(int64 handle, const char* sessionIdsJson, int32 begin, int32 end, _Out_ void** outJson)')

      // wcdb_status wcdb_get_available_years(wcdb_handle handle, const char* session_ids_json, char** out_json)
      try {
        this.wcdbGetAvailableYears = sf('int32 wcdb_get_available_years(int64 handle, const char* sessionIdsJson, _Out_ void** outJson)')
      } catch {
      ...
      try {
        this.wcdbGetAnnualReportStats = sf('int32 wcdb_get_annual_report_stats(int64 handle, const char* sessionIdsJson, int32 begin, int32 end, _Out_ void** outJson)')
      } catch {
      ...
      try {
        this.wcdbGetAnnualReportExtras = sf('int32 wcdb_get_annual_report_extras(int64 handle, const char* sessionIdsJson, int32 begin, int32 end, int32 peakBegin, int32 peakEnd, _Out_ void** outJson)')
      } catch {
      ...
      try {
        this.wcdbGetDualReportStats = sf('int32 wcdb_get_dual_report_stats(int64 handle, const char* sessionId, int32 begin, int32 end, _Out_ void** outJson)')
      } catch {
      ...
      try {
        this.wcdbGetLogs = sf('int32 wcdb_get_logs(_Out_ void** outJson)')
      } catch {
      ...
      try {
        this.wcdbGetGroupStats = sf('int32 wcdb_get_group_stats(int64 handle, const char* chatroomId, int32 begin, int32 end, _Out_ void** outJson)')
      } catch {
      ...
      try {
        this.wcdbGetMyFootprintStats = sf('int32 wcdb_get_my_footprint_stats(int64 handle, const char* optionsJson, _Out_ void** outJson)')
      } catch {
      ...
      try {
        this.wcdbGetMessageDates = sf('int32 wcdb_get_message_dates(int64 handle, const char* sessionId, _Out_ void** outJson)')
      } catch {
      ...
      this.wcdbOpenMessageCursor = sf('int32 wcdb_open_message_cursor(int64 handle, const char* sessionId, int32 batchSize, int32 ascending, int32 beginTimestamp, int32 endTimestamp, _Out_ int64* outCursor)')
      ...
      try {
        this.wcdbOpenMessageCursorLite = sf('int32 wcdb_open_message_cursor_lite(int64 handle, const char* sessionId, int32 batchSize, int32 ascending, int32 beginTimestamp, int32 endTimestamp, _Out_ int64* outCursor)')
      } catch {
      ...
      this.wcdbFetchMessageBatch = sf('int32 wcdb_fetch_message_batch(int64 handle, int64 cursor, _Out_ void** outJson, _Out_ int32* outHasMore)')

      // wcdb_status wcdb_close_message_cursor(wcdb_handle handle, wcdb_cursor cursor)
      this.wcdbCloseMessageCursor = sf('int32 wcdb_close_message_cursor(int64 handle, int64 cursor)')

      // wcdb_status wcdb_get_logs(char** out_json)
      this.wcdbGetLogs = sf('int32 wcdb_get_logs(_Out_ void** outJson)')

      // wcdb_status wcdb_exec_query(wcdb_handle handle, const char* db_kind, const char* db_path, const char* sql, char** out_json)
      this.wcdbExecQuery = sf('int32 wcdb_exec_query(int64 handle, const char* kind, const char* path, const char* sql, _Out_ void** outJson)')

      // wcdb_status wcdb_get_emoticon_cdn_url(wcdb_handle handle, const char* db_path, const char* md5, char** out_url)
      this.wcdbGetEmoticonCdnUrl = sf('int32 wcdb_get_emoticon_cdn_url(int64 handle, const char* dbPath, const char* md5, _Out_ void** outUrl)')

      // wcdb_status wcdb_get_emoticon_caption(wcdb_handle handle, const char* db_path, const char* md5, char** out_caption)
      try {
        this.wcdbGetEmoticonCaption = sf('int32 wcdb_get_emoticon_caption(int64 handle, const char* dbPath, const char* md5, _Out_ void** outCaption)')
      } catch (e) {
      ...
      try {
        this.wcdbGetEmoticonCaptionStrict = sf('int32 wcdb_get_emoticon_caption_strict(int64 handle, const char* md5, _Out_ void** outCaption)')
      } catch (e) {
      ...
      this.wcdbListMessageDbs = sf('int32 wcdb_list_message_dbs(int64 handle, _Out_ void** outJson)')

      // wcdb_status wcdb_list_media_dbs(wcdb_handle handle, char** out_json)
      this.wcdbListMediaDbs = sf('int32 wcdb_list_media_dbs(int64 handle, _Out_ void** outJson)')

      // wcdb_status wcdb_get_message_by_id(wcdb_handle handle, const char* session_id, int32 local_id, char** out_json)
      this.wcdbGetMessageById = sf('int32 wcdb_get_message_by_id(int64 handle, const char* sessionId, int32 localId, _Out_ void** outJson)')

      // wcdb_status wcdb_get_db_status(wcdb_handle handle, char** out_json)
      try {
        this.wcdbGetDbStatus = sf('int32 wcdb_get_db_status(int64 handle, _Out_ void** outJson)')
      } catch {
      ...
      try {
        this.wcdbGetVoiceData = sf('int32 wcdb_get_voice_data(int64 handle, const char* sessionId, int32 createTime, int32 localId, int64 svrId, const char* candidatesJson, _Out_ void** outHex)')
      } catch {
        this.wcdbGetVoiceData = null
      }
      try {
        this.wcdbGetVoiceDataBatch = sf('int32 wcdb_get_voice_data_batch(int64 handle, const char* requestsJson, _Out_ void** outJson)')
      } catch {
        this.wcdbGetVoiceDataBatch = null
      }
      try {
        this.wcdbGetMediaSchemaSummary = sf('int32 wcdb_get_media_schema_summary(int64 handle, const char* dbPath, _Out_ void** outJson)')
      } catch {
        this.wcdbGetMediaSchemaSummary = null
      }
      try {
        this.wcdbGetSessionMessageCounts = sf('int32 wcdb_get_session_message_counts(int64 handle, const char* sessionIdsJson, _Out_ void** outJson)')
      } catch {
        this.wcdbGetSessionMessageCounts = null
      }
      try {
        this.wcdbGetSessionMessageTypeStats = sf('int32 wcdb_get_session_message_type_stats(int64 handle, const char* sessionId, int32 beginTimestamp, int32 endTimestamp, _Out_ void** outJson)')
      } catch {
        this.wcdbGetSessionMessageTypeStats = null
      }
      try {
        this.wcdbGetSessionMessageTypeStatsBatch = sf('int32 wcdb_get_session_message_type_stats_batch(int64 handle, const char* sessionIdsJson, const char* optionsJson, _Out_ void** outJson)')
      } catch {
        this.wcdbGetSessionMessageTypeStatsBatch = null
      }
      try {
        this.wcdbGetSessionMessageDateCounts = sf('int32 wcdb_get_session_message_date_counts(int64 handle, const char* sessionId, _Out_ void** outJson)')
      } catch {
        this.wcdbGetSessionMessageDateCounts = null
      }
      try {
        this.wcdbGetSessionMessageDateCountsBatch = sf('int32 wcdb_get_session_message_date_counts_batch(int64 handle, const char* sessionIdsJson, _Out_ void** outJson)')
      } catch {
        this.wcdbGetSessionMessageDateCountsBatch = null
      }
      try {
        this.wcdbGetMessagesByType = sf('int32 wcdb_get_messages_by_type(int64 handle, const char* sessionId, int64 localType, int32 ascending, int32 limit, int32 offset, _Out_ void** outJson)')
      } catch {
        this.wcdbGetMessagesByType = null
      }
      try {
        this.wcdbScanMediaStream = sf('int32 wcdb_scan_media_stream(int64 handle, const char* sessionIdsJson, int32 mediaType, int32 beginTimestamp, int32 endTimestamp, int32 limit, int32 offset, _Out_ void** outJson, _Out_ int32* outHasMore)')
      } catch {
        this.wcdbScanMediaStream = null
      }
      try {
        this.wcdbGetHeadImageBuffers = sf('int32 wcdb_get_head_image_buffers(int64 handle, const char* usernamesJson, _Out_ void** outJson)')
      } catch {
      ...
      try {
        this.wcdbSearchMessages = sf('int32 wcdb_search_messages(int64 handle, const char* sessionId, const char* keyword, int32 limit, int32 offset, int32 beginTimestamp, int32 endTimestamp, _Out_ void** outJson)')
      } catch {
      ...
      try {
        this.wcdbGetSnsTimeline = sf('int32 wcdb_get_sns_timeline(int64 handle, int32 limit, int32 offset, const char* username, const char* keyword, int32 startTime, int32 endTime, _Out_ void** outJson)')
      } catch {
      ...
      try {
        this.wcdbGetSnsAnnualStats = sf('int32 wcdb_get_sns_annual_stats(int64 handle, int32 begin, int32 end, _Out_ void** outJson)')
      } catch {
        this.wcdbGetSnsAnnualStats = null
      }
      try {
        this.wcdbGetSnsUsernames = sf('int32 wcdb_get_sns_usernames(int64 handle, _Out_ void** outJson)')
      } catch {
        this.wcdbGetSnsUsernames = null
      }
      try {
        this.wcdbGetSnsExportStats = sf('int32 wcdb_get_sns_export_stats(int64 handle, const char* myWxid, _Out_ void** outJson)')
      } catch {
        this.wcdbGetSnsExportStats = null
      }
      try {
        this.wcdbGetMessageTableColumns = sf('int32 wcdb_get_message_table_columns(int64 handle, const char* dbPath, const char* tableName, _Out_ void** outJson)')
      } catch {
        this.wcdbGetMessageTableColumns = null
      }
      try {
        this.wcdbListTables = sf('int32 wcdb_list_tables(int64 handle, const char* kind, const char* dbPath, _Out_ void** outJson)')
      } catch {
        this.wcdbListTables = null
      }
      try {
        this.wcdbGetTableSchema = sf('int32 wcdb_get_table_schema(int64 handle, const char* kind, const char* dbPath, const char* tableName, _Out_ void** outJson)')
      } catch {
        this.wcdbGetTableSchema = null
      }
      try {
        this.wcdbExportTableSnapshot = sf('int32 wcdb_export_table_snapshot(int64 handle, const char* kind, const char* dbPath, const char* tableName, const char* outputPath, _Out_ void** outJson)')
      } catch {
        this.wcdbExportTableSnapshot = null
      }
      try {
        this.wcdbImportTableSnapshot = sf('int32 wcdb_import_table_snapshot(int64 handle, const char* kind, const char* dbPath, const char* tableName, const char* inputPath, _Out_ void** outJson)')
      } catch {
        this.wcdbImportTableSnapshot = null
      }
      try {
        this.wcdbImportTableSnapshotWithSchema = sf('int32 wcdb_import_table_snapshot_with_schema(int64 handle, const char* kind, const char* dbPath, const char* tableName, const char* inputPath, const char* createTableSql, _Out_ void** outJson)')
      } catch {
        this.wcdbImportTableSnapshotWithSchema = null
      }
      try {
        this.wcdbGetMessageTableTimeRange = sf('int32 wcdb_get_message_table_time_range(int64 handle, const char* dbPath, const char* tableName, _Out_ void** outJson)')
      } catch {
        this.wcdbGetMessageTableTimeRange = null
      }
      try {
        this.wcdbResolveImageHardlink = sf('int32 wcdb_resolve_image_hardlink(int64 handle, const char* md5, const char* accountDir, _Out_ void** outJson)')
      } catch {
        this.wcdbResolveImageHardlink = null
      }
      try {
        this.wcdbResolveImageHardlinkBatch = sf('int32 wcdb_resolve_image_hardlink_batch(int64 handle, const char* requestsJson, _Out_ void** outJson)')
      } catch {
        this.wcdbResolveImageHardlinkBatch = null
      }
      try {
        this.wcdbResolveVideoHardlinkMd5 = sf('int32 wcdb_resolve_video_hardlink_md5(int64 handle, const char* md5, const char* dbPath, _Out_ void** outJson)')
      } catch {
        this.wcdbResolveVideoHardlinkMd5 = null
      }
      try {
        this.wcdbResolveVideoHardlinkMd5Batch = sf('int32 wcdb_resolve_video_hardlink_md5_batch(int64 handle, const char* requestsJson, _Out_ void** outJson)')
      } catch {
      ...
      try {
        this.wcdbInstallMessageAntiRevokeTrigger = sf('int32 wcdb_install_message_anti_revoke_trigger(int64 handle, const char* sessionId, _Out_ void** outError)')
      } catch {
      ...
      try {
        this.wcdbUninstallMessageAntiRevokeTrigger = sf('int32 wcdb_uninstall_message_anti_revoke_trigger(int64 handle, const char* sessionId, _Out_ void** outError)')
      } catch {
      ...
      try {
        this.wcdbCheckMessageAntiRevokeTrigger = sf('int32 wcdb_check_message_anti_revoke_trigger(int64 handle, const char* sessionId, _Out_ int32* outInstalled)')
      } catch {
      ...
      try {
        this.wcdbInstallSnsBlockDeleteTrigger = sf('int32 wcdb_install_sns_block_delete_trigger(int64 handle, _Out_ void** outError)')
      } catch {
      ...
      try {
        this.wcdbUninstallSnsBlockDeleteTrigger = sf('int32 wcdb_uninstall_sns_block_delete_trigger(int64 handle, _Out_ void** outError)')
      } catch {
      ...
      try {
        this.wcdbCheckSnsBlockDeleteTrigger = sf('int32 wcdb_check_sns_block_delete_trigger(int64 handle, _Out_ int32* outInstalled)')
      } catch {
      ...
      try {
        this.wcdbDeleteSnsPost = sf('int32 wcdb_delete_sns_post(int64 handle, const char* postId, _Out_ void** outError)')
      } catch {
      ...
      try {
        this.wcdbStartMonitorPipe = sf('int32 wcdb_start_monitor_pipe()')
        this.wcdbStopMonitorPipe = sf('void wcdb_stop_monitor_pipe()')
        this.wcdbGetMonitorPipeName = sf('int32 wcdb_get_monitor_pipe_name(_Out_ void** outName)')
      ...
      try {
        this.wcdbVerifyUser = sf('void VerifyUser(int64 hwnd, const char* message, _Out_ char* outResult, int maxLen)')
      } catch {
      ...
      try {
        this.wcdbCloudInit = sf('int32 wcdb_cloud_init(int32 intervalSeconds)')
      } catch {
      ...
      try {
        this.wcdbCloudReport = sf('int32 wcdb_cloud_report(const char* statsJson)')
      } catch {
      ...
      try {
        this.wcdbCloudStop = sf('void wcdb_cloud_stop()')
      } catch {
      ...
      console.error(`[wcdb-diag] wcdb_init() => ${initResult}`)
      if (initResult !== 0) {
        console.error('WCDB 初始化失败:', initResult)
        try { if (this.wcdbGetLogs) { const lp = [null as any]; if (this.wcdbGetLogs(lp) === 0 && lp[0]) { console.error('[wcdb-diag] DLL log:', this.koffi.decode(lp[0], 'char', -1)); this.wcdbFreeString(lp[0]) } } } catch {}
